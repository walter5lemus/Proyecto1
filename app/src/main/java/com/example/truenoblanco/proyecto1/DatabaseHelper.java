...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public String lleanarBD(){
        ...
        final int[] id = {0,1};
        final String[] name = {"Walter","Cristian"};
        final String[] email = {"walter.lemus@hotmail.com","cistian.sosa@hotmail.com"};
        final String[] uname = {"walter5lemus","cristiansosa"};
        final String[] pass = {"walter92","resnick"};
